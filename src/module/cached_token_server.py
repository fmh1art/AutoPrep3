...
class CachedTokenServer:
    ...
    def compute_cached_tokens(self, input_messages: list[dict]) -> int:
        ...
        with self._lock:
            ...
            if best_match_len > 0 and best_record_id is not None:
                ...
                return self._record_map[best_record_id][1][best_match_len - 1]
    ...
    def query_and_cache(
        ...
        cached_tokens = self.compute_cached_tokens(input_messages)
        self.cache_conversation(input_messages, response_msg)
