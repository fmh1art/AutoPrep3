"""
CodeAgent — OpenHands SDK Agent 的封装。
...
class CodeAgent:
    ...
    def run(
        ...
        # read the text in src/prompts/react_instruction.j2
        with open("./src/prompts/react_instruction.j2", "r") as f:
            react_instruction = f.read()
        prompt = instruction + "\n\n" + react_instruction
