...
from src.benchmarks.utils.constants import OUTPUT_FILENAME
from src.benchmarks.utils.critics import get_completed_instances
from src.benchmarks.utils.iterative import aggregate_results, get_failed_instances
from src.benchmarks.utils.laminar import LMNR_ENV_VARS, LaminarEvalMetadata, LaminarService
...
class Evaluation(ABC, BaseModel):
    ...
    async def _run_iterative_mode_async(
        ...
        *,
        ...
        from src.benchmarks.utils.worker_context import initialize as init_worker_ctx
